...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__F845369",
    appName: "pighand-AIO-applet",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "127.0.0.1,192.168.1.35,0.0.1.1,198.18.0.1,192.168.64.1,192.168.1.86";
  const port = "8090";
  const id = "mp-weixin_ZPvj1o";
