...
const formatData = ({
    ...
    if (queryData?.presentPrice) {
        queryData.presentPrice = new Decimal(queryData.presentPrice).div(100);
    }
    if (queryData?.originalPrice) {
        queryData.originalPrice = new Decimal(queryData.originalPrice).div(100);
    }

    if (saveData?.presentPrice) {
        saveData.presentPrice = new Decimal(saveData.presentPrice).mul(100);
    }
