package com.pighand.aio.domain.project;
 ...
 */
@Table(value = "project_platform_pay")
@Data
public class ProjectPlatformPayDomain extends BaseDomainRecord<ProjectPlatformPayDomain> implements Serializable {
